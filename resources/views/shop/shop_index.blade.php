                    ...
                    @foreach ($courses as $course)
                        <div class="col mb-5">
                            <div class="card h-100">
                                <!-- Product image-->
                                <div class="badge text-white position-absolute" style="top: 0.5rem; right: 0.5rem; background-color: var(--bs-dark);" onmouseover="this.style.backgroundColor='#424649';" onmouseout="this.style.backgroundColor='var(--bs-dark)';"><a class="icon-link link-light" href="{{ route('shop.detail', $course->id) }}">
                                ...
                                <div class="card-body p-4">
                                    <div class="text-center">
                                        ...
                                        <!-- Product price-->
                                        <span class="text-muted text-decoration-line-through">${{ ($course->price)*(1+0.15) }}</span>
                                        Price: <span class="text-success">${{$course->price}}</span>
                                    </div>
                                </div>
                                <!-- Product actions-->
                                <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                    <div class="text-center"><a class="btn btn-outline-dark mt-auto" href="{{ route('shop.add.to.cart', $course->id) }}"><i class="bi-cart-fill me-1"></i>Add to cart</a></div>
                                </div>
                            </div>
                        </div>
                    @endforeach
